...
class TestCase(unittest.TestCase):
    ...
    def test_make_unique_nickname(self):
        u=User(nickname='xyq20103139',email='xyq20103139@sina.com')
        db.session.add(u)
        db.session.commit()
        nickname=User.make_unique_nickname('John')
        assert nickname !='xyq20103139'
    ...
    def test_follow(self):
        u1=User(nickname='xyq20103139',email='xyq20103139@sina.com')
        ...
        assert u2.followers.first().nickname=='xyq20103139'
        u=u1.unfollow(u2)
        assert u!=None
        db.session.add(u)
        db.session.commit()
